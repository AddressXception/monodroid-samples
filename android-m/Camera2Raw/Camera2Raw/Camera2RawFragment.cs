...
namespace Camera2Raw
{
	public class Camera2RawFragment : Fragment, View.IOnClickListener
	{
		...
		static void Setup3AControlsLocked (CaptureRequest.Builder builder)
		{
			...
			builder.Set (CaptureRequest.ControlMode,
			...
			if (Contains (mCharacteristics.Get (
				    CameraCharacteristics.ControlAwbAvailableModes).ToArray<int> (),
				    (int)ControlAwbMode.Auto)) {
				// Allow AWB to run auto-magically if this device supports this
				builder.Set (CaptureRequest.ControlAwbMode,
					(int)ControlAwbMode.Auto);
			}
		}
